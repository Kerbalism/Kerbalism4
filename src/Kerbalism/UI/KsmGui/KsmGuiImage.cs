...
{
	public class KsmGuiImage : KsmGuiBase
	{
		public RawImage Image { get; private set; }
		public RectTransform IconTransform { get; private set; }

		public KsmGuiImage(KsmGuiBase parent, Texture2D texture, int iconWidth = -1, int iconHeight = -1) : base(parent)
		{
			// we use a child gameobject because KsmGuiImage can be used as a button (we need it as a child in this case)
