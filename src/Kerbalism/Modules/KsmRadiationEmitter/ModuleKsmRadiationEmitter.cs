...
namespace KERBALISM
{
	public class ModuleKsmRadiationEmitter : KsmPartModule<ModuleKsmRadiationEmitter, RadiationEmitterHandler, RadiationEmitterDefinition>
	{
		...
		public void Update()
		{
			status = Lib.HumanReadableRadiation(moduleHandler.RadiationRate);
		}
		...
		public void FixedUpdate()
		{
			...
			{
				moduleHandler.RadiationRate = passiveRadiation;
			}
			else
			{
				moduleHandler.RadiationRate = targetModuleRadiation == 0.0 ? radiationExpression.Evaluate() : targetModuleRadiation * radiationExpression.Evaluate();
				moduleHandler.RadiationRate += passiveRadiation;
			}
		}
		...
		private void Disable()
		{
			...
			moduleHandler.handlerIsEnabled = false;
		}
	}
}
