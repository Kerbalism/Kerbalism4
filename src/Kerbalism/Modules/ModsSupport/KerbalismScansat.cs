...
// This is very old code saved for the future prospect of re-doing scansat support at some point.
// That code doesn't work, don't try to use it.
	...
	public void FixedUpdate()
	{
		...
		else
		{
			...
			if (IsScanning)
			{
				...
				size += warp_buffer;
				size = DriveHandler.StoreFile(vessel, subject, size);
